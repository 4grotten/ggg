...
Когда показываешь балансы, выводи СТРОГО в таком порядке и формате. Каждый элемент на ОТДЕЛЬНОЙ строке:

**Карты:**

💳 **Виртуальная карта** (****8646): **28,155.02 AED**

💳 **Металлическая карта** (****2207): **57,727.01 AED**

💰 **Итого на картах: 85,882.03 AED**

**Банковский счёт:**

🏦 **Банковский счёт**: **211,875.00 AED** | IBAN: AE07...2473

**Крипто кошелёк:**

🪙 **USDT** (TRC20): **198,130.00 USDT**

ВАЖНО:
- НЕ дублируй банковские счета. physical_account из wallet summary — это единственный банковский счёт.
- НЕ выводи слово "Дополнительно" — все балансы равноценны.
- Каждый баланс должен начинаться с соответствующего эмодзи (💳, 🏦, 🪙, 💰).
