        ...
        <div className="flex-1 mx-4 mb-4 bg-[#1a2332] rounded-3xl flex flex-col items-center justify-between py-8 px-6 overflow-hidden">
          {capturedImage ? (
            ...
            <>
              ...
              {/* Label */}
              <p className="text-white text-xl font-semibold mb-6">{t('verify.capture.frontSide')}</p>
            ...
            <>
              <div className="flex-1 flex items-center justify-center w-full relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="relative w-full max-w-[320px] aspect-[1.6/1]">
                    ...
                    <div className="absolute inset-0 bg-[#5a6575]/40 rounded-xl flex p-4 pointer-events-none">
                      <div className="w-1/3 bg-[#7a8595]/50 rounded-lg flex items-center justify-center mr-4">
                        <User className="w-14 h-14 text-[#9ca3af]/70" />
                      </div>
                      <div className="flex-1 flex flex-col justify-between py-3">
                        ...
                        <div className="h-3.5 bg-[#9ca3af]/50 rounded-full w-1/2" />
                        <div className="h-3.5 bg-[#9ca3af]/40 rounded-full w-2/3 self-end" />
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Label */}
              <p className="text-white text-xl font-semibold mb-6 relative z-10">{t('verify.capture.frontSide')}</p>
...
export default DocumentCaptureFront;
