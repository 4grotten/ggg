        ...
        >
          ...
          <div className="relative flex items-end justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-black/80 bg-white/30 backdrop-blur-sm px-3 py-1 rounded-full">
                {cardData.holderName}
              </span>
            </div>
      ...
      >
        ...
        <div className="relative flex items-end justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white/90 bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full">
              {cardData.holderName}
            </span>
          </div>
          
          {/* Visa branding */}
          <span className="text-2xl font-bold text-white/70 italic tracking-tight">VISA</span>
        </div>
      </div>
    );
  };
