...
import { ChevronLeft, ChevronDown, Lock, RefreshCw, Eye, EyeOff, X, Copy, ChevronUp, Wallet } from "lucide-react";
  ...
  return (
    ...
    >
      <PullToRefresh onRefresh={handleRefresh}>
        ...
        {/* Card Visual */}
        <motion.div 
          className="relative w-full max-w-xs sm:max-w-sm mx-auto aspect-[1.586/1] rounded-2xl overflow-hidden"
