        ...
        {isLoading ? (
          ...
          <>
            ...
            {currentDevice && (
              <div className="space-y-2">
                <h2 className="text-sm font-medium text-muted-foreground px-1">
                  {t("settings.devices.currentDevice") || "Current Device"}
                </h2>
            ...
            {otherDevices.length > 0 && (
              <div className="space-y-2">
                <h2 className="text-sm font-medium text-muted-foreground px-1">
                  {t("settings.devices.otherDevices") || "Other Devices"} ({otherDevices.length})
                </h2>
            ...
            <div className="flex items-center justify-center gap-2 py-2">
              <span className="text-sm text-muted-foreground">
                {t("settings.devices.activeCount", { count: activeDevicesCount }) || `${activeDevicesCount} active sessions`}
              </span>
            </div>
                  ...
                  {(() => {
                    ...
                    return (
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                        ...
                        <DeviceIcon className={`w-6 h-6 ${isCurrent ? 'text-primary' : 'text-foreground'}`} />
                      </div>
                    );
                  })()}
                  <div>
          ...
          <div className="px-6 py-8 space-y-6">
            <div className="flex flex-col items-center text-center space-y-3">
              ...
              <h3 className="text-lg font-semibold text-foreground">
                {t("settings.devices.confirmLogoutAllTitle") || "End All Sessions?"}
              </h3>
              <p className="text-sm text-muted-foreground">
                {t("settings.devices.confirmLogoutAllDesc") || "This will log you out from all devices including this one. You will need to sign in again."}
              </p>
            </div>
