...
// Confirm Password Input with character-by-character matching
  ...
  return (
    <div className="space-y-2">
      <div className="relative">
        ...
        <div 
          className={`flex h-14 w-full rounded-2xl border bg-card px-4 pr-12 items-center transition-colors duration-300 ${
            showError 
              ? "border-destructive" 
          ...
          {confirmPassword.length === 0 ? (
            <div className="flex items-center">
              ...
              <span className="text-muted-foreground text-base">
                {t('editProfile.changePassword.confirmPlaceholder') || 'Повторите пароль'}
              </span>
            </div>
          ) : (
            ...
            {allMatch ? (
              ...
              >
                ...
                <span className="text-xs font-medium">
                  {t("editProfile.changePassword.passwordsMatch") || "Пароли совпадают"}
                </span>
              </motion.div>
            ) : (
              <motion.span
              ...
              >
                {t("editProfile.changePassword.passwordsNotMatch") || "Пароли не совпадают"}
              </motion.span>
            )}
          </motion.div>
        )}
...
const ProfileSteps = () => {
      ...
      case "password":
        ...
        return (
          ...
          >
            ...
            <p className="text-muted-foreground text-center mb-6">{t('auth.steps.password.description')}</p>
            ...
            <div className="w-full space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">
                  {t('editProfile.changePassword.newPassword') || 'Новый пароль'}
                </label>
                <div className="relative">
                  <input
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium text-foreground">
                  {t('editProfile.changePassword.confirmPassword') || 'Подтвердите пароль'}
                </label>
  ...
  const getButtonState = () => {
    ...
    switch (currentStep) {
      ...
      case "password":
        const passwordsAreMatching = password.length >= 6 && password === confirmPassword;
        return { disabled: !passwordsAreMatching, text: continueText };
      case "complete":
