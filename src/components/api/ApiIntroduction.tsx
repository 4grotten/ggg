      ...
      >
        <div className="p-4 rounded-xl bg-primary/5 border border-primary/20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">{t("api.baseUrl.accounts", "Accounts & Auth")}</p>
              <code className="text-lg font-mono text-primary">https://apofiz.com/api/v1</code>
            </div>
          </div>
          <p className="text-xs text-muted-foreground mt-2 ml-[52px]">
            {t("api.baseUrl.accountsDesc", "Authentication, profile, contacts, social links, devices")}
          </p>
        </div>
        ...
        <div className="p-4 rounded-xl bg-primary/5 border border-primary/20">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm text-muted-foreground">{t("api.baseUrl.cards", "Cards & Transactions")}</p>
              <code className="text-lg font-mono text-primary">https://ueasycard.com/api/v1</code>
            </div>
          </div>
          <p className="text-xs text-muted-foreground mt-2 ml-[52px]">
            {t("api.baseUrl.cardsDesc", "Cards, balances, top-ups, transfers, withdrawals, crypto wallets")}
          </p>
        </div>
      </motion.div>
