        ...
        <div className="relative z-10 flex flex-col items-center gap-4">
          ...
          >
            <Button
              ...
              className="flex-1 h-10 rounded-xl bg-[#007AFF] border-[#0066DD] text-white hover:bg-[#0066DD] shadow-[0_4px_20px_rgba(0,122,255,0.5)] hover:shadow-[0_6px_25px_rgba(0,122,255,0.6)]"
            >
